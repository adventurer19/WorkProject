...
namespace Illuminate\Support\Facades {
  ...
  class App {
     ...
     * @static
     */
    public static function callMethodBinding(
      $method,
      $instance
    ) {            //Method inherited from \Illuminate\Container\Container
      /** @var \Illuminate\Foundation\Application $instance */
     ...
     * @static
     */
    public static function singletonIf(
      $abstract,
      $concrete = NULL
    ) {            //Method inherited from \Illuminate\Container\Container
      /** @var \Illuminate\Foundation\Application $instance */
     ...
     * @static
     */
    public static function scopedIf(
      $abstract,
      $concrete = NULL
    ) {            //Method inherited from \Illuminate\Container\Container
      /** @var \Illuminate\Foundation\Application $instance */
     ...
     * @static
     */
    public static function rebinding(
      $abstract,
      $callback
    ) {            //Method inherited from \Illuminate\Container\Container
      /** @var \Illuminate\Foundation\Application $instance */
     ...
     * @static
     */
    public static function beforeResolving(
      $abstract,
      $callback = NULL
    ) {            //Method inherited from \Illuminate\Container\Container
      /** @var \Illuminate\Foundation\Application $instance */
     ...
     * @static
     */
    public static function resolving(
      $abstract,
      $callback = NULL
    ) {            //Method inherited from \Illuminate\Container\Container
      /** @var \Illuminate\Foundation\Application $instance */
     ...
     * @static
     */
    public static function afterResolving(
      $abstract,
      $callback = NULL
    ) {            //Method inherited from \Illuminate\Container\Container
      /** @var \Illuminate\Foundation\Application $instance */
  ...
  class Auth {
    ...
    /**
     * Determine if the current user is authenticated. If not, throw an
     * exception.
     *
     * @return \App\Models\User
     * @throws \Illuminate\Auth\AuthenticationException
   ...
   *   channel(string $channel, callable|string $callback, array $options = [])
  ...
  class Bus {
    ...
    /**
     * Assert if a job was explicitly dispatched synchronously based on a
     * truth-test callback.
     *
     * @param  string|\Closure  $command
     * @param  callable|int|null  $callback
    ...
    /**
     * Assert if a job was dispatched after the response was sent based on a
     * truth-test callback.
     *
     * @param  string|\Closure  $command
     * @param  callable|int|null  $callback
    ...
    /**
     * Assert if a job was dispatched with an empty chain based on a truth-test
     * callback.
     *
     * @param  string|\Closure  $command
     * @param  callable|null  $callback
    ...
    /**
     * Get all of the jobs dispatched synchronously matching a truth-test
     * callback.
     *
     * @param  string  $command
     * @param  callable|null  $callback
    ...
    /**
     * Get all of the jobs dispatched after the response was sent matching a
     * truth-test callback.
     *
     * @param  string  $command
     * @param  callable|null  $callback
  ...
  class Cache {
     ...
     *
     * @param  \Psr\SimpleCache\iterable  $keys  A list of keys that can
     ...
     * @return \Psr\SimpleCache\iterable A list of key => value pairs. Cache
     ...
     *   item. If no value is sent and the driver supports TTL then the library
     ...
     *
     * @param  \Psr\SimpleCache\iterable  $values  A list of key => value pairs
     *   for a multiple-set operation.
     * @param  null|int|\DateInterval  $ttl  Optional. The TTL value of this
     *   item. If no value is sent and the driver supports TTL then the library
     *   may set a default value for it or let the driver take care of that.
     *
    ...
    /**
     * Get an item from the cache, or execute the given Closure and store the
     * result.
     *
     * @param  string  $key
     * @param  \DateTimeInterface|\DateInterval|int|null  $ttl
     ...
     *
     * @param  \Psr\SimpleCache\iterable  $keys  A list of string-based keys to
     *   be deleted.
     *
     * @return bool
  ...
  class Cookie {
    ...
    public static function make(
      ...
      return $instance->make($name, $value, $minutes, $path, $domain, $secure,
   ...
   * @method static \Illuminate\Support\Carbon createFromDate($year = NULL,
   *   $month = NULL, $day = NULL, $tz = NULL)
   * @method static \Illuminate\Support\Carbon createFromTime($hour = 0,
   *   $minute = 0, $second = 0, $tz = NULL)
   ...
   *   $tz = NULL)
   * @method static \Illuminate\Support\Carbon
   ...
   * @method static \Illuminate\Support\Carbon useStrictMode($strictModeEnabled
   *   = TRUE)
   * @method static \Illuminate\Support\Carbon yesterday($tz = NULL)
   * @method static \Illuminate\Support\Carbon|false createFromFormat($format,
   *   $time, $tz = NULL)
   * @method static \Illuminate\Support\Carbon|false createSafe($year = NULL,
   *   $month = NULL, $day = NULL, $hour = NULL, $minute = NULL, $second =
   *   NULL, $tz = NULL)
   * @method static \Illuminate\Support\Carbon|null make($var)
   * @method static \Symfony\Component\Translation\TranslatorInterface
   *   getTranslator()
   ...
   * @method static void
   *   setTranslator(\Symfony\Component\Translation\TranslatorInterface
   *   $translator)
  ...
  class DB {
     ...
     * @static
     */
    public static function affectingStatement(
      $query,
      $bindings = []
    ) {            //Method inherited from \Illuminate\Database\Connection
      /** @var \Illuminate\Database\MySqlConnection $instance */
    ...
    /**
     * Indicate that the connection should use the write PDO connection for
     * reads.
     *
     * @param  bool  $value
     *
     ...
     * @static
     */
    public static function getDoctrineColumn(
      $table,
      $column
    ) {            //Method inherited from \Illuminate\Database\Connection
      /** @var \Illuminate\Database\MySqlConnection $instance */
    ...
    /**
     * Get the current PDO connection parameter without executing any reconnect
     * logic.
     *
    ...
    /**
     * Get the current read PDO connection parameter without executing any
     * reconnect logic.
     *
     * @return \PDO|\Closure|null
     * @static
     ...
     * @static
     */
    public static function resolverFor(
      $driver,
      $callback
    ) {            //Method inherited from \Illuminate\Database\Connection
  ...
  class File {
    ...
    /**
     * Write the contents of a file, replacing it atomically if it already
     * exists.
     *
     * @param  string  $path
  ...
  class Gate {
    ...
    /**
     * Determine if all of the given abilities should be granted for the
     * current user.
     *
    ...
    /**
     * Determine if any one of the given abilities should be granted for the
     * current user.
     *
     * @param  \Illuminate\Auth\Access\iterable|string  $abilities
     * @param  array|mixed  $arguments
    ...
    /**
     * Determine if all of the given abilities should be denied for the current
     * user.
     *
     * @param  \Illuminate\Auth\Access\iterable|string  $abilities
     * @param  array|mixed  $arguments
   ...
   *
   *
   * @method static \Illuminate\Http\Client\PendingRequest accept(string
   *   $contentType)
   ...
   *   $name, string $contents = '', string|null $filename = NULL, array
   *   $headers = [])
   * @method static \Illuminate\Http\Client\PendingRequest baseUrl(string $url)
   * @method static \Illuminate\Http\Client\PendingRequest
   *   beforeSending(callable $callback)
   * @method static \Illuminate\Http\Client\PendingRequest bodyFormat(string
   *   $format)
   * @method static \Illuminate\Http\Client\PendingRequest contentType(string
   *   $contentType)
   * @method static \Illuminate\Http\Client\PendingRequest dd()
   * @method static \Illuminate\Http\Client\PendingRequest dump()
   * @method static \Illuminate\Http\Client\PendingRequest retry(int $times,
   *   int $sleep = 0, ?callable $when = NULL)
   * @method static \Illuminate\Http\Client\PendingRequest sink(string|resource
   *   $to)
   * @method static \Illuminate\Http\Client\PendingRequest stub(callable
   *   $callback)
   * @method static \Illuminate\Http\Client\PendingRequest timeout(int
   *   $seconds)
   ...
   * @method static \Illuminate\Http\Client\PendingRequest withCookies(array
   *   $cookies, string $domain)
   * @method static \Illuminate\Http\Client\PendingRequest
   *   withDigestAuth(string $username, string $password)
   * @method static \Illuminate\Http\Client\PendingRequest withHeaders(array
   *   $headers)
   * @method static \Illuminate\Http\Client\PendingRequest
   *   withMiddleware(callable $middleware)
   * @method static \Illuminate\Http\Client\PendingRequest withOptions(array
   *   $options)
   * @method static \Illuminate\Http\Client\PendingRequest withToken(string
   *   $token, string $type = 'Bearer')
   * @method static \Illuminate\Http\Client\PendingRequest withUserAgent(string
   *   $userAgent)
   ...
   * @method static \Illuminate\Http\Client\Response head(string $url,
   *   array|string|null $query = NULL)
   * @method static \Illuminate\Http\Client\Response patch(string $url, array
   *   $data = [])
   * @method static \Illuminate\Http\Client\Response post(string $url, array
   *   $data = [])
   * @method static \Illuminate\Http\Client\Response put(string $url, array
   *   $data = [])
   * @method static \Illuminate\Http\Client\Response send(string $method,
  ...
  class Http {
    ...
    /**
     * Get an invokable object that returns a sequence of responses in order
    ...
    /**
     * Assert that a request / response pair was recorded matching a given
     * truth test.
     *
     * @param  callable  $callback
     *
    ...
    /**
     * Assert that a request / response pair was not recorded matching a given
     * truth test.
     *
     * @param  callable  $callback
     *
    ...
    /**
     * Get a collection of the request / response pairs matching the given
     * truth test.
     *
     * @param  callable  $callback
     *
  ...
  class Lang {
     ...
     * @static
     */
    public static function setParsedKey(
      $key,
      $parsed
   ...
   *
   *
   * @method static mixed laterOn(string $queue,
   *   \DateTimeInterface|\DateInterval|int $delay,
   *   \Illuminate\Contracts\Mail\Mailable|string|array $view)
   * @method static mixed queueOn(string $queue,
   *   \Illuminate\Contracts\Mail\Mailable|string|array $view)
  ...
  class Mail {
    ...
    /**
     * Determine if a mailable was not sent or queued to be sent based on a
     * truth-test callback.
     *
     * @param  string|\Closure  $mailable
     * @param  callable|null  $callback
   ...
   * @method static string sendResetLink(array $credentials, \Closure $callback
   *   = NULL)
   * @method static \Illuminate\Contracts\Auth\CanResetPassword getUser(array
   *   $credentials)
   * @method static string
   *   createToken(\Illuminate\Contracts\Auth\CanResetPassword $user)
   * @method static void
   *   deleteToken(\Illuminate\Contracts\Auth\CanResetPassword $user)
   * @method static bool
   *   tokenExists(\Illuminate\Contracts\Auth\CanResetPassword $user, string
   *   $token)
  ...
  class Queue {
    ...
    /**
     * Assert if a job was pushed with chained jobs based on a truth-test
     * callback.
     *
     * @param  string  $job
     * @param  array  $expectedChain
    ...
    /**
     * Assert if a job was pushed with an empty chain based on a truth-test
     * callback.
     *
     * @param  string  $job
     * @param  callable|null  $callback
  ...
  class Redirect {
    ...
    public static function signedRoute(
      ...
      /** @var \Illuminate\Routing\Redirector $instance */
      return $instance->signedRoute($route, $parameters, $expiration, $status,
        $headers);
    }
    ...
    public static function temporarySignedRoute(
      ...
      /** @var \Illuminate\Routing\Redirector $instance */
      return $instance->temporarySignedRoute($route, $expiration, $parameters,
        $status, $headers);
    }
  ...
  class Request {
    ...
    /**
     * Get the full URL for the request without the given query string
     * parameters.
     *
    ...
    public static function initialize(
      ...
      /** @var \Illuminate\Http\Request $instance */
      return $instance->initialize($query, $request, $attributes, $cookies,
     ...
     *
     * @param  array  $proxies  A list of trusted proxies, the string
     *   'REMOTE_ADDR' will be replaced with $_SERVER['REMOTE_ADDR']
     * @param  int  $trustedHeaderSet  A bit field of Request::HEADER_*, to set
     *   which headers to trust from your proxies
     *
     * @static
     */
     ...
     *
     * @return int A bit field of Request::HEADER_* that defines which headers
     *   are trusted from your proxies
     * @static
     */
     ...
     *
     * Be warned that enabling this feature might lead to CSRF issues in your
     * code. Check that you are using CSRF tokens when required. If the HTTP
     * method parameter override is enabled, an html-form with method "POST"
     * can be altered and used to send a "PUT" or "DELETE" request via the
     * _method request parameter. If these methods are not protected against
     * CSRF, this presents a possible vulnerability.
     *
     ...
     *
     * @return bool True when the _method request parameter is enabled, false
     *   otherwise
     * @static
     */
     ...
     * object, like whether the session is started or not. It is just a way to
     * check if this Request is associated with a Session instance.
     *
     ...
     *
     * Only the URIs path component (no schema, host etc.) is relevant and must
     * be given. Both paths must be absolute and not contain relative parts.
     * Relative URLs from one resource to another are useful when generating
     * self-contained downloadable document archives. Furthermore, they can be
     * used to reduce the link size in documents.
     *
     ...
     *
     * This method can read the client host name from the "X-Forwarded-Host"
     * header when trusted proxies were set via "setTrustedProxies()".
     *
     * The "X-Forwarded-Host" header must contain the client host name.
     *
     * @return string
     * @throws SuspiciousOperationException when the host name is invalid or
     *   not trusted
     * @static
     */
     ...
     * method, but only if enableHttpMethodParameterOverride() has been called.
     *
     ...
     *   preferred one must be the first as it will be used as the content
     *   type)
     *
     * @static
     */
     ...
     * server might be different. This returns the former (from the "Via"
     * header) if the proxy is trusted (see "setTrustedProxies()"), otherwise
     * it returns the latter (from the "SERVER_PROTOCOL" server parameter).
     *
     * @return string|null
     * @static
     */
     ...
     *
     * @return string|resource The request body content or a resource to read
     *   the body stream
     * @static
     */
    ...
    /**
     * Gets the preferred format for the response by inspecting, in the
     * following order:
     *   * the request format set using setRequestFormat;
     *   * the values of the Accept HTTP header.
     *
     * Note that if you use this method, you should send the "Vary: Accept"
     * header in the response to prevent any issues with intermediary HTTP
     * caches.
     *
     * @static
     */
    ...
    /**
     * Checks whether the client browser prefers safe content or not according
     * to RFC8674.
     *
     ...
     *
     * @return bool true if the request came from a trusted proxy, false
     *   otherwise
     * @static
     */
   ...
   * @method static \Illuminate\Routing\RouteRegistrar namespace(string|null
   *   $value)
  ...
  class Schema {
     ...
     * @static
     */
    public static function hasColumns(
      $table,
      $columns
    ) {            //Method inherited from \Illuminate\Database\Schema\Builder
      /** @var \Illuminate\Database\Schema\MySqlBuilder $instance */
     ...
     * @static
     */
    public static function registerCustomDoctrineType(
      $class,
      $name,
      $type
    ) {            //Method inherited from \Illuminate\Database\Schema\Builder
  ...
  class Session {
    ...
    /**
     * Determine if requests for the same session should wait for each to
    ...
    /**
     * Get the name of the cache store / driver that should be used to acquire
     * session locks.
     *
     * @return string|null
     * @static
...
'
    ...
    public static function getAwsTemporaryUrl(
      ...
      /** @var \Illuminate\Filesystem\FilesystemAdapter $instance */
      return $instance->getAwsTemporaryUrl($adapter, $path, $expiration,
        $options);
    }
  ...
  class URL {
    ...
    /**
     * Determine if the expires timestamp from the given request is not from
     * the past.
     *
     * @param  \Illuminate\Http\Request  $request
     *
  ...
  class Validator {
    ...
    /**
     * Indicate that unvalidated array keys should be excluded, even if the
     * parent array was validated.
     *
     * @return void
     * @static
     */
  ...
  class View {
    ...
    /**
     * Get the first view that actually exists from the given list, and start a
     * component.
     *
     * @param  array  $names
     * @param  array  $data
    ...
    /**
     * Get an item from the component data that exists above the current
     * component.
     *
     * @param  string  $key
     * @param  mixed  $default
...
namespace Facade\Ignition\Facades {
  ...
  class Flare {
    ...
    public static function register(
      ...
      return \Facade\FlareClient\Flare::register($apiKey, $apiSecret,
        $contextDetector, $container);
    }
...
namespace {
  ...
  class Eloquent extends \Illuminate\Database\Eloquent\Model {
    ...
    /**
     * Get a single column's value from the first result of the query or throw
     * an exception.
     *
     * @param  string|\Illuminate\Database\Query\Expression  $column
     *
    ...
    /**
     * Set the relationships that should be eager loaded while removing any
    ...
    public static function hasMorph(
      ...
      /** @var \Illuminate\Database\Eloquent\Builder $instance */
      return $instance->hasMorph($relation, $types, $operator, $count, $boolean,
        $callback);
    }
    ...
    public static function whereHasMorph(
      ...
      /** @var \Illuminate\Database\Eloquent\Builder $instance */
      return $instance->whereHasMorph($relation, $types, $callback, $operator,
        $count);
    }
    ...
    public static function orWhereHasMorph(
      ...
      /** @var \Illuminate\Database\Eloquent\Builder $instance */
      return $instance->orWhereHasMorph($relation, $types, $callback, $operator,
        $count);
    }
    ...
    /**
     * Add a polymorphic relationship condition to the query with a where
     * clause.
     *
     * @param  \Illuminate\Database\Eloquent\Relations\MorphTo|string  $relation
     * @param  string|array  $types
    ...
    /**
     * Add a polymorphic relationship condition to the query with an "or where"
     * clause.
     *
     * @param  \Illuminate\Database\Eloquent\Relations\MorphTo|string  $relation
     * @param  string|array  $types
    ...
    /**
     * Add a morph-to relationship condition to the query with an "or where"
     * clause.
     *
     * @param  \Illuminate\Database\Eloquent\Relations\MorphTo|string  $relation
     * @param  \Illuminate\Database\Eloquent\Model|string  $model
    ...
    public static function joinSub(
      ...
      /** @var \Illuminate\Database\Query\Builder $instance */
      return $instance->joinSub($query, $as, $first, $operator, $second, $type,
        $where);
    }
    ...
    /**
     * Insert or update a record matching the attributes, and fill it with
     * values.
     *
     * @param  array  $attributes
     * @param  array  $values
